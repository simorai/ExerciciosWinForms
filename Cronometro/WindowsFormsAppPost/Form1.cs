...
namespace WindowsFormsAppPost
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnGostar_Click_1(object sender, EventArgs e)
        {
            post.Gostar(); // Incrementa os gostos
            AtualizarExibicao(); // Atualiza os labels
        }
        ...
        /// <param name="e">Os argumentos do evento. Neste caso, não são utilizados.</param>
        private void btnNaoGostar_Click_1(object sender, EventArgs e)
        {
            post.NaoGostar(); // Incrementa os não gostos
            AtualizarExibicao(); // Atualiza os labels
        }
        ...
        /// </exception>
        private void btnSubmeter_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender">O objeto que desencadeou o evento, tipicamente o botão "Gostar".</param>
        /// <param name="e">Os argumentos do evento. Neste caso, não são utilizados.</param>
        private void btnGostar_Click(object sender, EventArgs e)
        {
            post.Gostar();
            AtualizarExibicao();
        }
